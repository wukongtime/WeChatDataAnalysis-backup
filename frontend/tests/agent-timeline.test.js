...
const setup = (extra={}) => mount(AgentRun,{props:{run:base(),now:105000,nearBottom:true,latest:true,viewState:{},...extra}})

describe('Agent 执行对话流',()=>{
  it('按顺序显示工具和关键进展，完成后折叠并可重新展开',async()=>{
    const w=setup()
