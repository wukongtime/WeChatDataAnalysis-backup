...
> **消息修改与消息补录只写本地解密副本**，单向生效、不回写微信，对方看不到改动；发送、朋友圈、群聊、联系人才是经微信客户端的真实操作，会话标记已读同样只在本地生效。
>
> 应用内点击侧边栏「高级功能」，或在官网的「PRO — 高级版」一幕里，可以逐项观看这 54 项能力的演示动画（左侧清单、右侧舞台，自动轮播，点任一项即切换）。动画仅为功能示意，不会操作真实微信；会话标记已读不代表服务器已读回执。
